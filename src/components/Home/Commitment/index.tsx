...
const Commitment: React.FC = () => {
    const tags = ["Growth", "Success", "Innovate", "Lead", "Impact", "Focus", "Tech"];
    return (
        <>
            <section className="bg-light overflow-hidden py-14 lg:py-18 xl:py-22 bg-prim-light">
                <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4 space-y-8">
                    <div className="commitment-content bg-white p-8 rounded-2xl">
                        ...
                        <h2 className='mt-4 font-chakrapetch lg:text-35 font-semibold mb-5'>Committed Delivering Measurable Results and Building from the Lasting Relationships through out trust and innovation and corporate shared
                        </h2>
                        <Link
                            href="/services"
                        ...
                        <div className='w-full bg-white p-8 rounded-2xl'>
                            ...
                            <div className='flex gap-5'>
                                ...
                                <p className='text-pera-dark'>
                                    Satisfied customers work with our AdriaMat AI.
                                </p>
                            </div>
                        </div>
